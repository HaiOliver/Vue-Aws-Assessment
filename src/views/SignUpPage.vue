<template>
  <div>
    <form v-if="!confirmPassword" class="flex flex-col items-center" @submit.prevent="signUp">
      ...
      <div class="flex flex-col mt-2">
        <label class="block text-gray-700 text-3xl font-bold" for="email">Email</label>
        <input
          class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
          type="email"
          id="email"
      ...
      <!-- eslint-disable -->
      <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mb-8 rounded">Sign Up</button>
    </form>
    ...
    <div v-if="confirmPassword" class="w-4/12 m-auto">
      ...
      <div class="flex flex-col mt-2">
        <label class="block text-gray-700  text-3xl font-bold" for="password">Code</label>
        <input
        ...
        />
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mb-8 rounded" @click="confirmSignUp">Confirm Code</button>
      </div>
    </div>
  </div>
</template>
